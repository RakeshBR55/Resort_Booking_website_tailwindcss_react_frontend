...
<div className="bg-orange-100 min-h-screen flex flex-col">
            <div className="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
                <form onSubmit={submitForm} className="bg-green-100 px-6 py-8 rounded-lg shadow-2xl text-black w-full">
                    <h1 className="mb-8 text-3xl text-green-600 text-center text- font-bold">Sign up</h1>
                    <input 
                        type="text"
