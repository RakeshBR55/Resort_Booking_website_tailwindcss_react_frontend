      ...
      <div className="mt-2">
        <div className="w-full flex-1">
          <div className="my-2 p-1  flex rounded">
            <h1 className="text-3xl mx-auto font-Rubik text-green-300">
        ...
        <div className="flex flex-col md:flex-row ">
          <div className=" flex flex-col md:flex-row mx-auto">
            <button
              className="text-sm  mx-auto w-32  focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer 
