    ...
    '>
        ...
        <div className='hidden md:flex '>
            <ul className='flex text-black items-center p-3'>
                ...
                <li><Link to="/Gallery" className='p-2'>Gallery</Link></li>
                <li><Link to="/Signup" className='p-2'>Sign Up</Link></li>
        ...
        {/* Mobile menu */}
        <div className= {nav ? ' w-full bg-black text-white absolute top-[60px] left-0 flex justify-center text-center' : 'absolute left-[-100%]'}>
