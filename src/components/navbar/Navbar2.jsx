  ...
  return (
    <>
            <div className="bg-transparent h-full w-full">
                {/* Code block starts */}
                <nav className="bg-transparent shadow xl:block hidden">
...
{/* For laptop display  */}
                                ...
                                <div className="flex items-center">
                                    ...
                                    <h2 className="hidden sm:block text-base text-gray-700 font-bold leading-normal pl-3"><Link to="/" className="p-2">
                Madhu Home Stay
              </Link></h2>
                                </div>
                            </div>
                            <div className="flex">
                                <div className="hidden xl:flex md:mr-6 xl:mr-16">
                                    <a href="javascript: void(0)" className="flex px-5 items-center py-6 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none transition duration-150 ease-in-out">
                                        <span className="mr-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0V0z"/><path d="M10 19v-5h4v5c0 .55.45 1 1 1h3c.55 0 1-.45 1-1v-7h1.7c.46 0 .68-.57.33-.87L12.67 3.6c-.38-.34-.96-.34-1.34 0l-8.36 7.53c-.34.3-.13.87.33.87H5v7c0 .55.45 1 1 1h3c.55 0 1-.45 1-1z"/></svg>
                                        </span>
                ...
                About
                                    ...
                                    <a href="javascript: void(0)" className="flex px-5 items-center py-6 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none transition duration-150 ease-in-out">
                                        <span className="mr-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 64 64" width={20} height={20} viewBox="0 0 64 64"><path d="M44.6,58.7H22.2c-3.5,0-6.7-1.4-9.2-3.8c-2.5-2.5-3.8-5.7-3.8-9.2c0-0.6,0.4-1,1-1s1,0.4,1,1c0,2.9,1.1,5.7,3.2,7.8
	...
	c3.5,0,6.7,1.4,9.2,3.8c2.5,2.5,3.8,5.7,3.8,9.2v28c0,3.5-1.4,6.7-3.8,9.2C51.3,57.4,48,58.7,44.6,58.7z"/><path d="M10.3 30.8c-2.8 0-5-2.2-5-5s2.2-5 5-5 5 2.2 5 5S13.1 30.8 10.3 30.8zM10.3 22.8c-1.7 0-3 1.3-3 3s1.3 3 3 3 3-1.3 3-3S12 22.8 10.3 22.8zM10.3 42.4c-2.8 0-5-2.2-5-5s2.2-5 5-5 5 2.2 5 5S13.1 42.4 10.3 42.4zM10.3 34.4c-1.7 0-3 1.3-3 3s1.3 3 3 3 3-1.3 3-3S12 34.4 10.3 34.4zM45.4 33.2c-.8-1.9-2.1-3.5-3.9-4.7-.8-.5-1.1-1.6-.7-2.5.6-1.2.8-2.7.6-4.2-.5-3-3-5.4-6-5.7-4.5-.5-8.1 3-7.9 7.4.2 2.9 2.2 5.4 5 6.2 2 .6 4 .2 5.5-.7 2.7 1.1 4.5 2.8 5.4 5 1.3 3 .8 6.6.2 8.7-.2.9-1 1.5-1.9 1.5H27.2c-.8 0-1.6-.5-1.9-1.3-2.3-6.7 2.1-11.3 2.3-11.5.4-.4.4-1 0-1.4s-1-.4-1.4 0c0 .1-6.4 6.7-1.9 15.7.2.4.5.6.9.6H44c.4 0 .7-.3.8-.7C44.9 45.3 47.8 38.8 45.4 33.2zM29.5 22.6c.2-2 1.5-3.7 3.4-4.3 3.5-1.1 7 1.7 6.6 5.3-.3 2.4-2.3 4.3-4.7 4.4C31.7 28.1 29.3 25.7 29.5 22.6z"/></svg>
                ...
                Contact
                                    ...
                                    <a href="javascript: void(0)" className="flex px-5 items-center py-6 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none transition duration-150 ease-in-out">
                                        <span className="mr-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M19.777,6.387h-2.212c-0.214,0-0.406-0.136-0.48-0.337l-0.578-1.592c-0.244-0.675-0.891-1.127-1.608-1.127H9.102
	...
	s1.302-2.9,2.9-2.9s2.9,1.302,2.9,2.9S13.599,16.351,12,16.351z"/></svg>
                                        </span>
                                                ...
                                                <ul className="p-2 w-40 border-r bg-white absolute rounded right-0 shadow top-0 mt-16 ">
                                                    <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                                        <div className="flex items-center">
                                                            ...
                                                            <span className="ml-2"><Link to="/userprofile" className="p-2">
                My profile
              </Link></span>
                                                        </div>
                                                    </li>
                                                    <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex items-center">
                                                        ...
                                                        <span className="ml-2"><Link to="/" className="p-2">
                Logout
              </Link></span>
                                                    </li>
...
{/*Mobile responsive sidebar*/}
                                        ...
                                        <div className="mt-6 flex w-full items-center justify-between">
                                            <div className="flex items-center justify-between w-full">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="text-base md:text-2xl text-gray-800 ml-3"><Link to="/" className="p-2">
                Madhu Home Stay
              </Link></p>
                                                </div>
                                            ...
                                            <a className="cursor-pointer">
                                                <li className="text-gray-800 pt-10">
                                                    <div className="flex items-center">
                                                        ...
                                                        <p className="text-indigo-700 xl:text-base text-base ml-3"><Link to="/" className="p-2">
                Home
              </Link></p>
                                                    </div>
                                                </li>
                                                ...
                                                <li className="text-gray-800 pt-8">
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center">
                                                            ...
                                                            <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3"><Link to="/About" className="p-2">
                About
              </Link></p>
                                                        </div>
                                                    </div>
	...
	c3.5,0,6.7,1.4,9.2,3.8c2.5,2.5,3.8,5.7,3.8,9.2v28c0,3.5-1.4,6.7-3.8,9.2C51.3,57.4,48,58.7,44.6,58.7z"/><path d="M10.3 30.8c-2.8 0-5-2.2-5-5s2.2-5 5-5 5 2.2 5 5S13.1 30.8 10.3 30.8zM10.3 22.8c-1.7 0-3 1.3-3 3s1.3 3 3 3 3-1.3 3-3S12 22.8 10.3 22.8zM10.3 42.4c-2.8 0-5-2.2-5-5s2.2-5 5-5 5 2.2 5 5S13.1 42.4 10.3 42.4zM10.3 34.4c-1.7 0-3 1.3-3 3s1.3 3 3 3 3-1.3 3-3S12 34.4 10.3 34.4zM45.4 33.2c-.8-1.9-2.1-3.5-3.9-4.7-.8-.5-1.1-1.6-.7-2.5.6-1.2.8-2.7.6-4.2-.5-3-3-5.4-6-5.7-4.5-.5-8.1 3-7.9 7.4.2 2.9 2.2 5.4 5 6.2 2 .6 4 .2 5.5-.7 2.7 1.1 4.5 2.8 5.4 5 1.3 3 .8 6.6.2 8.7-.2.9-1 1.5-1.9 1.5H27.2c-.8 0-1.6-.5-1.9-1.3-2.3-6.7 2.1-11.3 2.3-11.5.4-.4.4-1 0-1.4s-1-.4-1.4 0c0 .1-6.4 6.7-1.9 15.7.2.4.5.6.9.6H44c.4 0 .7-.3.8-.7C44.9 45.3 47.8 38.8 45.4 33.2zM29.5 22.6c.2-2 1.5-3.7 3.4-4.3 3.5-1.1 7 1.7 6.6 5.3-.3 2.4-2.3 4.3-4.7 4.4C31.7 28.1 29.3 25.7 29.5 22.6z"/></svg>
                                                        ...
                                                        <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3"><Link to="/Contact" className="p-2">
                Contact
              </Link></p>
                                                    </div>
                                                </li>
	...
	s1.302-2.9,2.9-2.9s2.9,1.302,2.9,2.9S13.599,16.351,12,16.351z"/></svg>
                                                        ...
                                                        <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3"><Link to="/Gallery" className="p-2">
                Gallery
              </Link></p>
                                                    </div>
                                                </div>
                                            ...
                                            <li className="text-gray-800 pt-8 cursor-pointer">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center">
                                                        ...
                                                        <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3"><Link to="/Signup" className="p-2">
                  Sign Up
                </Link></p>
                                                    </div>
                                                </div>
                                            ...
                                            <li className="text-gray-800 pt-8 cursor-pointer">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center">
                                                        ...
                                                        <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3"><Link to="/login" className="p-2">
                  Login 
                </Link></p>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="border-t border-gray-300">
                                            <div className="w-full flex items-center justify-between pt-1">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className=" text-gray-800 text-base leading-4 ml-2"><Link to="/userprofile" className="p-2">
                My profile
              </Link></p>
                                                </div>
                                                <ul className="flex">
