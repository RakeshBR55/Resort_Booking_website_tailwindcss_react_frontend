...
const Hero2 = () => {
  return (
    <div className="py-20 2xl:px-0 lg:px-12 px-4 2xl:mx-auto 2xl:container bg-blue-100 rounded-xl">
      <div className="md:flex items-center justify-between w-full bg-blue-100 ">
        <div className="xl:w-1/3 md:w-1/2 w-full">
          <h1
            role="heading"
            className="focus:outline-none md:w-60 font-bold md:text-6xl text-center text-4xl leading-tight text-gray-800"
          >
            MADHU<span className="font-normal italic"> Homestay </span>
          </h1>
          <p
            role="contentinfo"
