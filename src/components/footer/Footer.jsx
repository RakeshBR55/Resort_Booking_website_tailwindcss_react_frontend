  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="mt-8">
        ...
        <p className="mb-4">
          <Link to="/" className="text-grey-600">Home</Link>
        </p>
        <p className="mb-4">
          <Link to="/About" className="text-grey-600">About</Link>
        </p>
        <p className="mb-4">
          <Link to="/Contact" className="text-grey-600">Contact</Link>
        </p>
        <p>
          <Link to="/Gallery" className="text-grey-600">Gallery</Link>
        </p>
      </div>
      <div className="">
        ...
        <p className="mb-4">
          <Link to="/UserProfile" className="text-grey-600">Booking status</Link>
        </p>
        <p className="mb-4">
          <Link to="/" className="text-grey-600">Services</Link>
        </p>
        <p className="mb-4">
          <Link to="/Login" className="text-grey-600">Login</Link>
        </p>
        <p>
          <Link to="/Signup" className="text-grey-600">Sign Up</Link>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
